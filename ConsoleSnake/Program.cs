...
namespace ConsoleSnake
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            game.InitGameField(Visualizer.SIDE_SIZE, Visualizer.FIELD_X_START, Visualizer.FIELD_Y_START);
            ...
            do//while (choiceMenu != (byte)MenuChois.ButtonExit);
            {
                ...
                if (!DLWorker.ExistsDir(game.HomeDir)) DLWorker.CreatDir(game.HomeDir);
                ...
                if (choiceMenu == (byte)MenuChois.ButtonLoad) ConnectHelper.WorkWithLoad(ref choiceMenu, saver, ref game);
